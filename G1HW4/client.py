...
def start_client(host="127.0.0.1", port=9999):
    ...
    expression_file = os.path.join(r"C:\\Users\\ksh07\\Desktop\\file", f"{client_id}.file")
    ...
    for file_key, chunks_list in received_chunks.items():
        if all(chunks_list):
            output_file_path = os.path.join(r"C:\\Users\\ksh07\Desktop\\file", f"{client_id}_{file_key}_complete.file")
